...
\begin{itemize}
    \item \role{Consultant en IA}{Avril 2025 -- Présent}
          ...
          Conseil aux entreprises sur l'adoption de l'IA et livraison de solutions de bout en bout (machine learning, deep learning, NLP), notamment des assistants intégrés aux ERP tels qu'Odoo.
          \begin{itemize}
              \item Identifier les cas d'usage IA à fort impact (CRM, ventes, inventaire, RH) et prototyper des solutions NLP / ML branchées sur Odoo et d'autres processus métier.
              \item Conception et mise en production d'une plateforme d'agents IA multi-départements (RH, Finance, Management, IT) en projet solo.
