...
\begin{itemize}
    \item \role{AI Consultant}{April 2025 -- Present}
          ...
          Advise enterprise clients on AI adoption and deliver end-to-end solutions spanning machine learning, deep learning, and NLP --- including assistants integrated with ERP systems such as Odoo.
          \begin{itemize}
              \item Identify high-impact AI use cases across business processes (CRM, sales, inventory, HR) and prototype NLP / ML solutions wired into Odoo and other enterprise workflows.
              \item Designed and shipped a multi-department AI agent platform (HR, Finance, Management, IT) as a solo project.
