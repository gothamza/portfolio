...
\newcommand{\profilephoto}{%
    \begin{tikzpicture}
        ...
        \node[anchor=center] at (0,0) {%
            \includegraphics[width=2.0cm]{profile-photo.jpg}%
        };
        \draw[accent, line width=1.2pt] (0,0) circle (1.0cm);
    \end{tikzpicture}%
}
...
\begin{itemize}
    \item \role{AI Consultant}{April 2025 -- Present}
          ...
          \begin{itemize}
              ...
              \item Secured LLM APIs (chat, RAG, image generation) with typed schemas, JWT/OAuth2, and role-based access for users and collections.
    ...
    \item \role{AI Intern}{February 2024 -- August 2024}
          ...
          \begin{itemize}
              ...
              \item Exposed Stable Diffusion~1.5 image-generation endpoints and a RAG pipeline over Wikipedia/PDF; FastAPI with JWT auth.
